...
var testDSNs = []struct {
	...
	"username:password@protocol(address)/dbname?param=value&psMultiResults=true",
	&Config{User: "username", Passwd: "password", Net: "protocol", Addr: "address", DBName: "dbname", Params: map[string]string{"param": "value"}, Collation: "utf8mb4_general_ci", Loc: time.UTC, MaxAllowedPacket: defaultMaxAllowedPacket, AllowNativePasswords: true, PSMultiResults: true},
}, {
